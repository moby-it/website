...
<template>
  <ul class="nav-links">
    ...
    <li>
      <NuxtLink active-class="active" to="/products" @click="() => $emit('linkClicked', e)">Products
      </NuxtLink>
    </li>
    <li>
    ...
    <li>
      <NuxtLink active-class="active" to="https://gspanos.tech" target="_blank" @click="() => $emit('linkClicked', e)">
        Blog</NuxtLink>
    </li>
    <li>
