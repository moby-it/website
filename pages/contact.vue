...
async function submitForm() {
    ...
    if (!success) {
        ...
        const unwatch = watchEffect(() => {
            ...
            if (localStatus.value === 'success') unwatch();
        ...
        <Card min-width="60%">
            ...
            <template v-if="status !== 'success'" #content>
                ...
                <section class="contact-body">
                    <p>
                        Hello Moby! My name is
                        <input name="username" v-model="form.name" placeholder="Your Name" />.
                    </p>
                    ...
                    <textarea
                        ...
                        name="details"
                        id="details"
                        placeholder="I'd also like to learn more about..."
                    ></textarea>
            ...
            <template v-else #content>
                <h4 style="text-align: center; margin-bottom: var(--gap-2)">
                    We got your message and we'll reach out to you shortly!
                </h4>
